...
//             <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#8a7a63] flex justify-between items-center" >
...
export default function Tracker() {
  ...
  function handleBudgetSubmit(e: React.FormEvent) {
    ...
    // Persist budget
    localStorage.setItem("ipon-budget", String(amount));
      ...
      {isBudgetModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md rounded-3xl border border-[#2c2115]/15 bg-[#fffdf7] p-7 shadow-2xl">
            ...
            <form onSubmit={handleBudgetSubmit} className="mt-6 space-y-5">
              <div>
                <label
                  htmlFor="budget"
                  className="block text-xs font-semibold uppercase tracking-[0.15em] text-[#8a7a63]"
